                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    <header class="entry-header">
                        ...
                        <nav id="image-navigation">
                            <span class="previous-image"><?php previous_image_link(
                                    false,
                                    __('&larr; Previous', 'htif')
                                ); ?></span>
                            <span class="next-image"><?php next_image_link(false, __('Next &rarr;', 'htif')); ?></span>
                        </nav>
                        <!-- #image-navigation -->
                    </header>
                    <!-- .entry-header -->
                            ...
                            <div class="attachment">
                                ...
                                <a href="<?php echo $next_attachment_url; ?>"
                                   title="<?php echo esc_attr(get_the_title()); ?>" rel="attachment"><?php
                                    $attachment_size = apply_filters('htif_attachment_size', 1200);
                                    echo wp_get_attachment_image(
                                        $post->ID,
                                        array($attachment_size, $attachment_size)
                    ...
                    <footer class="entry-meta">
                        ...
                        <?php elseif (!comments_open() && !pings_open()) : // Comments and trackbacks closed ?>
                            <?php _e('Both comments and trackbacks are currently closed.', 'htif'); ?>
                        <?php endif; ?>
